...
export const TRANSLATIONS = {
  en: {
    ...
    productBrowse: {
      ...
      buyEntryFindAlternative: "+ Alternative",
      buyEntrySubAlternativeBadge: "Alternative",
      buyEntrySubSheetTitle: "Find alternative for {name}",
      buyEntrySubSheetSubtitle: "Showing options at {chain}",
      buyEntrySubSheetSearching: "Looking for alternatives at {chain}...",
      buyEntrySubSheetNoMatch: "No alternative found at {chain}",
      buyEntrySubReplace: "Replace",
      buyEntrySubSkip: "Skip",
      buyEntrySubUndo: "Undo substitution",
      buyEntrySubAlternativesHeading: "Other options",
      buyEntryReplaceAll: "Replace all missing items ({n})",
      buyEntryReplaceAllRunning: "Looking for alternatives for {n} items...",
      buyEntrySubChange: "Change",
      buyEntryShopWithPricepilot: "Shop with PricePilot",
  ...
  he: {
    ...
    productBrowse: {
      ...
      buyEntryFindAlternative: "+ חלופה",
      buyEntrySubAlternativeBadge: "חלופה",
      buyEntrySubSheetTitle: "מצא חלופה ל-{name}",
      buyEntrySubSheetSubtitle: "מציג אפשרויות ב-{chain}",
      buyEntrySubSheetSearching: "מחפש חלופות ב-{chain}...",
      buyEntrySubSheetNoMatch: "לא נמצאה חלופה ב-{chain}",
      buyEntrySubReplace: "החלף",
      buyEntrySubSkip: "דלג",
      buyEntrySubUndo: "בטל חלופה",
      buyEntrySubAlternativesHeading: "אפשרויות נוספות",
      buyEntryReplaceAll: "החלף את כל הפריטים החסרים ({n})",
      buyEntryReplaceAllRunning: "מחפש חלופות עבור {n} פריטים...",
      buyEntrySubChange: "החלף",
      buyEntryShopWithPricepilot: "קנה עם PricePilot",
